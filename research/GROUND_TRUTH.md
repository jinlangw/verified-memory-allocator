...
- Project-wide `spec_drift check` invocation for this repository layout is unresolved: attempts with module `verus-mimalloc` and `.` both failed with `pipeline_state.json not found`.
