...
uninterp spec fn local_direct_update(loc1: Local, loc2: Local, i: int, j: int, pq: int) -> bool;


uninterp spec fn pfd_direct_update(pfd1: Seq<*mut Page>, pfd2: Seq<*mut Page>, i: int, j: int, emp: *mut Page, p: *mut Page) -> bool;
